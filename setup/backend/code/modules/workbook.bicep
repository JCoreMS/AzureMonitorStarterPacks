...
var wbConfig='''
{
  ...
  "items": [
    ...
    },
    {
      ...
      "content": {
        ...
        "links": [
          ...
          {
            "id": "791ceced-e729-402a-ad2a-a2a76f8a3527",
            "cellValue": "tabSelection",
            "linkTarget": "parameter",
            "linkLabel": "Discovery",
            "subTarget": "discovery",
    ...
    },
    {
      ...
      "content": {
        "version": "KqlItem/1.0",
        "query": "amsplinuxdiscovery_CL\n| parse RawData with DiscoveryTime \",\" Name \",\" Type \",\" remainder\n| project-away RawData\n| extend Computer=tostring(split(_ResourceId,\"/\")[8])\n| summarize by Computer",
        "size": 0,
        "title": "Computers with Discovered Applications",
        "timeContext": {
          "durationMs": 86400000
        },
        "queryType": 0,
