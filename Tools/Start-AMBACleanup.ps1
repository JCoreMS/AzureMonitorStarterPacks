...
Write-Host -ForegroundColor Red "Found '$($alertResourceIds.Count)' metric, activity log and log alerts with tag '_deployed_by_amba=True' to be deleted."
...
Write-Host "Found '$($resourceGroupIds.Count)' resource groups with tag '_deployed_by_amba=True' to be deleted." -ForegroundColor Red
...
Write-Host "Found '$($policyAssignmentIds.Count)' policy assignments with metadata '_deployed_by_amba=True' to be deleted." -ForegroundColor Red
...
Write-Host "Found '$($policySetDefinitionIds.Count)' policy set definitions with metadata '_deployed_by_amba=True' to be deleted." -ForegroundColor Red
...
Write-Host -ForegroundColor Red "Found '$($policyDefinitionIds.Count)' policy definitions with metadata '_deployed_by_amba=True' to be deleted."
...
Write-Host -ForegroundColor Red "Found '$($roleAssignments.Count)' role assignment with description '_deployed_by_amba' to be deleted."
...
Else {
    ...
    Write-Host -ForegroundColor Yellow "Alerts to be deleted:"
    $alertResourceIds
    Write-Host -ForegroundColor Yellow "Resource groups to be deleted:"
    $resourceGroupIds
    Write-Host -ForegroundColor Yellow "Policy assignments to be deleted:"
    $policyAssignmentIds
    Write-Host -ForegroundColor Yellow "Policy set definitions to be deleted:"
    $policySetDefinitionIds
    Write-Host -ForegroundColor Yellow "Policy definitions to be deleted:"
    $policyDefinitionIds
    Write-Host -ForegroundColor Yellow "Role assignments to be deleted:"
    $roleAssignments.Id
